.. raw:: html
   ...
   <p>
     ...
     <a href="http://pypi.python.org/packages/2.5/p/pyephem/pyephem-3.7.3.2.win32-py2.5.exe"
      >Python 2.5 Windows installer<br/>
     <a href="http://pypi.python.org/packages/2.4/p/pyephem/pyephem-3.7.3.2.win32-py2.4.exe#md5=a56315f8742222da4eb054ea7e05df9f"
      >Python 2.4 Windows installer<br/>
     <a href="http://pypi.python.org/packages/source/p/pyephem/pyephem-3.7.3.2.tar.gz#md5=cb2932f8d9074a8a90e2af869940a0ee"
...
Version **3.7.3.2** is the most recent release of PyEphem.
