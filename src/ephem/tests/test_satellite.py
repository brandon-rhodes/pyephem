...
class SatelliteTests(unittest.TestCase):
    ...
    def test_next_pass(self):
        ...
        self.assertAlmostEqual(ephem.Date('2009/4/30 5:02:17'), rt, places=3)
        self.assertAlmostEqual(ephem.Date('2009/4/30 5:06:39'), tt, places=3)
        self.assertAlmostEqual(ephem.Date('2009/4/30 5:11:04'), st, places=3)

        self.assertAlmostEqual(ephem.degrees('192.0'), raz, places=1)
        self.assertAlmostEqual(ephem.degrees('16.0'), talt, places=1)
        self.assertAlmostEqual(ephem.degrees('64.9'), saz, places=1)
